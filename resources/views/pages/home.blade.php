        ...
        <div class="flex flex-col justify-between p-4 leading-normal">
            ...
            @auth
                @if (Auth::user()->role !== 'admin')
                    <a href="/create-my-report"
                        class="text-white text-center font-semibold bg-green-400 hover:bg-blue-800 hover:text-white focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Tulis Laporan
                    </a>
                @endif
            @endauth
