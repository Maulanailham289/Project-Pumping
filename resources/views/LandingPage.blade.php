        ...
        <div class="max-w-screen-xl m-0 sm:m-10 bg-white sm:rounded-lg flex justify-center flex-1">
            <div class="flex-1 text-center hidden lg:flex">
                <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat"
                    style="background-image: url('{{ asset('img/img-landingpage.jpg') }}')">
                </div>
            </div>
            <div class="lg:w-1/2 p-6 sm:p-12 flex flex-col items-start justify-center">
                ...
                <h1 class="mt-6 font-medium">Hai Moms, Kami menyediakan panduan pemerahan yang nyaman dan higenis,
                    membantu para
                    ibu menyusui
                    memenuhi kebutuhan nutrisi terbaik bagi buah hati dengan mudah. Dari Pumping Record untuk mencatat
                    perkembangan ASI dan konsultasi secara online atau offline, kami hadir sebagai solusi praktis untuk
                    para ibu modern
                </h1>
                <button
